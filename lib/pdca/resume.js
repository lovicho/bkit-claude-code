...
function createResumePoint(feature, context = {}) {
  ...
  const resumeData = {
    ...
    isValid: true,
    context: {
      // v2.1.34: preserve "not measured" across a resume rather than reviving
      // the cycle with a fabricated 0%.
      matchRate: typeof context.matchRate === 'number' && Number.isFinite(context.matchRate)
        ? context.matchRate
        : null,
