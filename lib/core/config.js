...
function getUIConfig() {
  return {
    sessionTitle: {
      // ENH-419 (v2.1.33), Issue #77: opt-IN. Repeated user reports asked bkit to
      // stop naming sessions; PDCA users can re-enable via ui.sessionTitle.enabled.
      enabled: getConfig('ui.sessionTitle.enabled', false),
