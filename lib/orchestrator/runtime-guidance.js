/**
 * @module orchestrator/runtime-guidance
 * @version 2.1.28
 */
...
function resolvePdcaPhase(args) {
  ...
  // `primaryFeature`. Reading it always produced undefined, so this fallback
  // never once supplied a feature name.
  const feature = (args && args.feature) || (status && status.primaryFeature) || '';
