...
| Quality | code-analyzer agent, bkit-rules skill, destructive-detector (16 known-pattern rules, segment-scoped; target-graded where the target decides the stakes), blast radius analysis |
...
| **Security Vulnerabilities** | Found post-hoc | Destructive detector (16 known-pattern rules, segment-scoped; target-graded where the target decides the stakes) + blast radius analysis |
