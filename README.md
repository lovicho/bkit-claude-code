...
[![Version](https://img.shields.io/badge/Version-2.1.32-green.svg)](CHANGELOG.md)
...
44 skills · 34 agents · 22 hook events / 25 blocks · 2 MCP servers (19 tools) · 195 lib modules across 22 subdirs · 62 scripts · 40 templates · 347 test files. Clean Architecture 4-Layer · Defense-in-Depth 4-Layer · Invocation Contract L1–L5 (226 CI-gated assertions).
...
| [CHANGELOG.md](CHANGELOG.md) | Release history (single source of truth — latest release: v2.1.32) |
